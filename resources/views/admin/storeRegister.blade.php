...
-->
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" required autocomplete="name" autofocus placeholder="港区">
                        ...
                        <div class="row mb-3">
                            <label for="businessDay" class="col-md-4 col-form-label text-md-end">営業日</label>

                            <div class="col-md-6">
                                <input id="businessDay" type="text" class="form-control @error('businessDay') is-invalid @enderror" name="businessDay" value="{{ old('businessDay') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="businessHours" class="col-md-4 col-form-label text-md-end">営業時間</label>

                            <div class="col-md-6">
                                <input id="businessHours" type="text" class="form-control @error('businessHours') is-invalid @enderror" name="businessHours" value="{{ old('businessHours') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="store_url" class="col-md-4 col-form-label text-md-end">使用URL（アルファベット表記）</label>

                            <div class="col-md-6">
                                <input id="store_url" type="text" class="form-control @error('store_url') is-invalid @enderror" name="store_url" value="{{ old('store_url') }}" required autocomplete="name" autofocus pattern="^[0-9a-zA-Z]+$">
