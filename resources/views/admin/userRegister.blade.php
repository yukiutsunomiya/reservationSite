...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">店舗【{{$name}}】のユーザー登録</div>

                <div class="card-body">
                    <!--<form method="POST" action="registerByAdmin">-->
...
-->
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6" id="store_url">
                                <p>{{$store_url}}</p>
                                <input id="store_url" type="hidden" name="store_url" value="{{$store_url}}">
                                <!--
